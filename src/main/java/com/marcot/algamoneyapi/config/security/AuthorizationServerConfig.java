...
public class AuthorizationServerConfig {
    public static final long EXPIRATION_TIME = 30; // 30 min
    static final String CLIENT_ID = "Angular";
    static final String CLIENT_SECRET = "@ngul@r0";
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        RegisteredClient angularClient = RegisteredClient
                ...
                .redirectUris(uris -> uris.addAll(Collections.singleton("http://localhost:8080")))
                .scope("read")
                .scope("write")
                .clientSettings(
